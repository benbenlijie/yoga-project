...
if __name__ == '__main__':
    ...
    # evolve_config = config.copy()
    # evolve loop
    # gaussian_scale target="data_loader;args;gaussian_scale"
    ...
    for gaussian_scale in np.arange(0.1, 0.2, 0.02):
        ...
        for margin in np.arange(0.1, 0.4, 0.05):
            ...
            modification = {
                ...
                "name": f"Yoga_Score_score_finetune_gau{gaussian_scale}_margin{margin}"
            }
            evolve_config = ConfigParser(config._config, config._cmdarg, config.resume, modification)
            main(evolve_config)
